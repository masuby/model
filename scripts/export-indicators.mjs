...
const SRC = {
  ...
  'hazard:heatwave': ['TMA', 'ERA5 t2m climatology', 'temperature-based heat exposure (computed, capped 6.5)'],
  'hazard:lightning': ['TMA', 'Lake Victoria basin (NASA LIS/OTD)', 'documented lightning-hotspot overlay'],
  'hazard:volcano': ['TMA / PMO-DMD', 'Ol Doinyo Lengai, Rungwe, Kilimanjaro/Meru', 'documented overlay'],
  'hazard:zoonoses': ['MoA / MoH', '2020 desert locust, armyworm, livestock disease', 'documented overlay'],
  'hazard:earthquake': ['TMA / PMO-DMD', 'East African Rift seismicity (2016 Kagera Mw5.9)', 'rift-proximity overlay'],
  'hazard:wildfire': ['TMA / PMO-DMD', 'miombo dry-season fire regime', 'documented overlay'],
  'hazard:vehicleAccidents': ['PMO-DMD / TMA', 'highway corridors + urban traffic', 'documented overlay'],
  'hazard:hazardousMaterial': ['PMO-DMD', 'industrial / mining / gas-petroleum sites', 'documented overlay'],
